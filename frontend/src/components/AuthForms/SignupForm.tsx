          ...
          <Form>
            ...
            sx={{
              ...
              <FormControl
                fullWidth
                margin="normal"
                className={`mui-email-row${(touched.emailFront && errors.emailFront) || (touched.emailDomain && errors.emailDomain) ? ' mui-email-row-error' : ''}`}
              >
              ...
              {(touched.emailFront && errors.emailFront) || (touched.emailDomain && errors.emailDomain) ? (
                <Typography color="error" sx={{ mt: 0.5, mb: 1, fontSize: '0.75rem' }} className="auth-error">
                  {touched.emailFront && errors.emailFront ? errors.emailFront : ''}
